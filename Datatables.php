<?php if(!defined('BASEPATH')) exit('No direct script access allowed');
  /**
  * Datatables - CISS (CodeIgniter Server-Side)
  * 
  ...
  class Datatables
  {
    ...
    public function generate()
    {
      ...
      switch($num)
      {
        case 1:
          ...
          break;
        case 3:
          $this->__call('generate_from_tci', $args);
          break;
        default;
    ...
    */
    public function generate_from_tci($table, $columns, $index)
    {
      ...
      $data['result'] = $this->produce_output($columns, $iTotal, $iFilteredTotal, $rResult);
      $this->ci->load->view('ajax', $data);
    }
    ...
    */
    ...
    {
      die('Make a datatable output here based on passed sql statement. This will be your implementation.');
    }

/********************************** EVERYTHING BELOW WILL CHANGE BASED ON WHAT WE DEVELOP **********************************/
